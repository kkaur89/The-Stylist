      ...
      <div className="container">
        <div className="mainPage">
          ...
          <div className="main-content">
            ...
            <br/>
            <h3 className="header">{info.acf.widgets[3].text}</h3>
            <br/>
            ...
            <br/>
            <h3 className="header">{info.acf.widgets[9].text}</h3>
            <br/>
